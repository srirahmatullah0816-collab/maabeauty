    ...
    <div className="min-h-screen bg-pink-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-sm p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">Masuk ke akunmu</p>
        </div>
        ...
        <div className="mt-6 text-center space-y-2">
          <Link href="/forgot-password" className="text-sm text-pink-500 hover:underline block">Lupa password?</Link>
          <p className="text-sm text-gray-500">Belum punya akun? <Link href="/register" className="text-pink-500 hover:underline">Daftar sekarang</Link></p>
        </div>
      </div>
    </div>
  )
